...
= This version of the plugin has been discontinued =

This version of the Rezgo plugin has been discontinued and is no longer 
supported. Moving forward, you should be using the newer version of the 
plugin, <a href="https://wordpress.org/plugins/rezgo">which can be found 
here</a>. The new version of the Rezgo plugin is built based on the latest 
version of the Rezgo white label and includes the updated modern responsive 
layout and better theme support.
...
= 1.9.0 =
* Adding discontinued notice 

= 1.8.9 =
* Fixing disparities resulting from deprecated search_items query

= 1.8.8 =
* Update to search items API call in Rezgo class
